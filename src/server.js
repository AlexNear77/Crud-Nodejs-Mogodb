...
app.engine('.hbs',exphbs({ //  express handle se separa en dos conceptos,(partials y layouts) partials son pedasos de coidgo de html, en el cual se importan en otros html. colocanolas en views 
